    ...
    <div className="fixed inset-0 bg-transparent backdrop-blur-[1px] bg-opacity-50 flex justify-center items-center z-50 p-2 sm:p-4 md:p-6 lg:p-8">
      ...
      >
        <div className="overflow-y-auto w-full" style={{ maxHeight: "80vh" }}>
          ...
          {/* Button */}
          {data.buttontext && (
            <button className="bg-white text-black font-bold w-full sm:w-3/4 md:w-3/4 lg:w-2/3 xl:w-1/2 mx-auto block rounded-md py-2 sm:py-3 md:py-4 px-4 text-sm sm:text-base md:text-lg lg:text-xl transition hover:bg-[#ebbb53] hover:text-white mb-4 sm:mb-6 md:mb-8 text-center break-words whitespace-normal leading-snug">
              {data.buttontext}
            </button>
          )}
