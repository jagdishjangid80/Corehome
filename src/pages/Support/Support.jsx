  ...
  return (
    <div className="flex flex-col items-center text-white px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-6 sm:py-8 md:py-10 lg:py-12 bg-black min-h-screen">
      <div className="w-full max-w-[1440px] flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 md:gap-8 lg:gap-10">
        ...
        {/* Image Section */}
        <div className="w-full md:w-1/2 flex justify-center relative mb-6 md:mb-0">
          <div className="relative w-full max-w-[280px] sm:max-w-[380px] md:max-w-[430px] lg:max-w-[680px] aspect-video">
            {/* Base Image */}
            <img
              src={support}
            ...
            <img
              ...
              className="absolute top-0 right-0 translate-x-[20%] translate-y-[-30%]
              w-[60%] sm:w-[70%] md:w-[75%] lg:w-[80%] h-auto 
