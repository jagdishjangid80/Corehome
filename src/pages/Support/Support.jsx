...
const Support = () => {
  return (
    <div className="flex flex-col items-center text-white px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-10 md:py-12 lg:py-16 bg-black min-h-screen">
      <div className="w-full max-w-[1440px] flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-10 md:gap-12 lg:gap-16">
        {/* Text Section */}
        <div className="w-full md:w-1/2 space-y-6 sm:space-y-8 text-center md:text-left">
          ...
          <div className="space-y-4 sm:space-y-5">
            <h5 className="font-semibold text-xl sm:text-2xl text-amber-500">
              Our Values
            </h5>
        ...
        <div className="w-full md:w-1/2 flex justify-end relative mb-8 md:mb-0">
          <div className="relative w-full max-w-[280px] sm:max-w-[380px] md:max-w-[430px] lg:max-w-[680px] h-[600px]">
            {/* Base Image */}
            <img
              src={support}
            ...
            <img
              ...
              className="absolute top-[-60px] right-[-40px] sm:top-[-60px] sm:right-[-50px] 
              md:top-[-80px] md:right-[-60px] lg:top-[-100px] lg:right-[-70px]
              w-[55%] sm:w-[65%] md:w-[70%] lg:w-[75%] xl:w-[80%] h-auto 
              rounded-lg shadow-lg object-cover z-10"
            />
          </div>
        </div>
      </div>
