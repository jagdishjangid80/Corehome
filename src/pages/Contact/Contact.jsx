...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen w-full bg-black text-white px-6 lg:px-16 py-8">
      <div className="relative w-full lg:w-1/2 h-screen">
        ...
        <motion.div
          ...
          className="absolute inset-0 flex items-center justify-center text-white text-3xl sm:text-5xl font-bold drop-shadow-[0_2px_2px_rgba(0,0,0,0.9)]"
        >
          Let's Connect
        </motion.div>
      </div>
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center mt-8 lg:mt-0">
        <div className="bg-[#000000aa] shadow-xl shadow-black p-12 sm:p-15 w-full max-w-xl rounded-lg">
          <div className="mb-6 flex gap-4 justify-center">
            {["Customer Service", "Sales Department"].map((dept) => (
              <button
                key={dept}
                className={`flex-1 px-6 py-2 text-xl border-2 rounded-md cursor-pointer transition shadow-lg ${
                  selectedButton === dept
                    ? "bg-white text-black"
          ...
          <form className="space-y-6 w-full" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="w-full border-b p-4 bg-transparent focus:outline-none focus:ring-0 text-lg text-white"
                required
              />
            </div>
            <div>
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="w-full bg-white text-black p-4 text-lg rounded-md hover:bg-[#ebbb53] cursor-pointer transition shadow-lg text-center"
              >
                Submit
              </button>
            </div>
