    ...
    <div className="bg-black text-white">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 px-4 sm:px-6 lg:px-8 pt-10 sm:pt-14 lg:pt-20 pb-6 sm:pb-10 lg:pb-16">
        <div className="flex flex-col items-start">
          <h1 className="text-xl sm:text-6xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 lg:mb-8">
            About Us
          </h1>
          <img
            src={image1}
            alt="About Us"
            className="hidden sm:block w-full h-auto max-w-[200px] sm:max-w-[280px] md:max-w-[340px] lg:max-w-[480px] xl:max-w-[560px] rounded-lg shadow-lg"
          />
        </div>
        <div className="flex flex-col items-start space-y-4 sm:space-y-6 md:space-y-5 lg:space-y-8">
          <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl leading-relaxed mt-3">
          ...
          <div className="flex flex-col md:flex-row gap-3 md:gap-4 w-full">
            <Link to="/brand">
              <button className="w-full md:w-auto px-4 py-2 md:px-5 md:py-2.5 bg-white text-black text-sm md:text-base lg:text-lg font-bold uppercase rounded hover:bg-[#ebbb53] transition duration-300">
                Explore Our Brands
              </button>
            </Link>

            <button className="w-full md:w-auto px-4 py-2 md:px-5 md:py-2.5 border border-white text-sm md:text-base lg:text-lg font-bold uppercase rounded hover:bg-white hover:text-black transition duration-300">
              Learn More
            </button>
          </div>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 px-4 sm:px-6 lg:px-8 pt-10 sm:pt-14 lg:pt-20 pb-6 sm:pb-10 lg:pb-16">
        <div className="space-y-4 sm:space-y-6 md:space-y-5 lg:space-y-8">
          ...
          <div className="space-y-4 md:space-y-5 lg:space-y-6">
            <div>
              <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-amber-400">
                Passion
              </h2>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl leading-relaxed">
        ...
        <div className="flex justify-center md:justify-end">
          <img
            ...
            alt="Who We Are"
            className="w-full max-w-[240px] sm:max-w-[400px] md:max-w-[400px] lg:max-w-[640px] xl:max-w-[780px] rounded-lg shadow-lg"
          />
        </div>
      </div>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 pt-8 pb-6 px-4 sm:px-6 lg:px-8">
        <div className="flex justify-center md:justify-start">
          <img
            ...
            alt="What We Do"
            className="w-full max-w-[240px] sm:max-w-[400px] lg:h-[785px] md:max-w-[400px] lg:max-w-[670px] xl:max-w-[780px] rounded-lg shadow-lg"
          />
        </div>
        <div className="space-y-4 md:space-y-5 lg:space-y-6">
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-3 lg:gap-4">
            {categoriesWithImages.map((item, index) => (
              <div key={index} className="flex flex-col items-center">
                <img
                  src={item.image}
                  alt={item.name}
                  className="w-12 h-12 sm:w-14 sm:h-14 md:w-15 md:h-15 lg:w-16 lg:h-16"
                />
                <span className="font-semibold text-xs sm:text-sm md:text-base lg:text-lg mt-2 text-center">
                  {item.name}
                </span>
              </div>
            ))}
